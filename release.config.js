...
!GIT_COMMITTER_NAME && (process.env.GIT_COMMITTER_NAME = "medijobs-automator[bot]");
!GIT_COMMITTER_EMAIL && (process.env.GIT_COMMITTER_EMAIL = "159287579+medijobs-automator[bot]@users.noreply.github.com");
